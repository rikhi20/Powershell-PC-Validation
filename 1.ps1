...
$null = $Host.UI.RawUI.ReadKey([System.Management.Automation.Host.ReadKeyOptions]::NoEcho -bor [System.Management.Automation.Host.ReadKeyOptions]::IncludeKeyDown) # Waits for any key press
...
$appsToCheck = @(
    ...
    @{ Name = "LastPass Desktop"; Search = @("LastPass"); Exec = @() },
